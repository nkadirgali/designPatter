...
import DesignPattern.Project.Factory.Navigator;
import DesignPattern.Project.Factory.TransportFactory;
...
public class Program {
    ...
    Transport transport = tf.createTransport(false);
...
//                print(exit);
                ...
                if(transport.getCar()!=null) car = transport.getCar();
